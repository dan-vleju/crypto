...
- (void)drawValueWithContext:(CGContextRef _Nonnull)context value:(NSString * _Nonnull)value xPos:(CGFloat)xPos yPos:(CGFloat)yPos font:(NSFont * _Nonnull)font align:(NSTextAlignment)align color:(NSColor * _Nonnull)color anchor:(CGPoint)anchor angleRadians:(CGFloat)angleRadians;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<ChartHighlight *> * _Nonnull)indices;
@end
...
///
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <ScatterChartDataSetProtocol> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(NSColor * _Nonnull)color;
@end
...
- (nonnull instancetype)initWithImage:(NSImage * _Nonnull)image isTiled:(BOOL)isTiled;
- (void)fillPathWithContext:(CGContextRef _Nonnull)context rect:(CGRect)rect;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, strong) NSColor * _Nullable labelColor;
